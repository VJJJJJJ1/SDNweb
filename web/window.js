...
var window = floaty.window(
    <vertical h="250dp" w="200dp">
        <button layout_weight="1" id="mYbattery" line="2" color="#000000" bg="#FDF5E6" textSize="17sp">电量</button>
        <button layout_weight="1" id="mYtime" line="2" color="#000000" bg="#FAF0E6" textSize="17sp">时间</button>
        <button layout_weight="1" id="mYwifi" line="2" color="#000000" bg="#FAEBD7" textSize="17sp">网络</button>
        <button layout_weight="1" id="mYBluetooth" line="2" color="#000000" bg="#FFF0F5" textSize="17sp">蓝牙</button>
        <button id="test" text="调整悬浮窗" bg="#FFE4E1" textSize="17sp"></button>
    </vertical>
);
